...
import com.skiff.test.Constants;
...
public class ReportUtil {
	...
	public static void main(String[] arg) throws Exception {
		...
		Xls_Reader suiteXLS = new Xls_Reader(System.getProperty("user.dir")+"//src//com//skiff//xls//Suite.xlsx");
		// create index.html
		...
		try{
			 ...
			 // out.write("<tr><td width=20% align= center><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>TC04</b></td><td width=40% align= center><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>TC04</b></td><td width=10% align=center  bgcolor=yellow><FONT COLOR=153E7E FACE=Arial SIZE=2><b>Skip</b></td></tr>");
			  ...
			  for(int currentSuiteID =2;currentSuiteID<= totalTestSuites;currentSuiteID++){
				  ...
				  current_suite_xls=new Xls_Reader(System.getProperty("user.dir")+"//src//com//skiff//xls//"+currentTestSuite+".xlsx");
				  ...
				  // add basic format to suite xls Test
					 ...
					 */
				     for(int currentTestCaseID=2;currentTestCaseID<=current_suite_xls.getRowCount(Constants.TEST_CASES_SHEET);currentTestCaseID++){
				    	 ...
				    	 currentTestName = current_suite_xls.getCellData(Constants.TEST_CASES_SHEET, Constants.TEST_CASE_ID, currentTestCaseID);
				    	 currentTestDescription = current_suite_xls.getCellData(Constants.TEST_CASES_SHEET, Constants.DESCRIPTION, currentTestCaseID);
				    	 currentTestRunmode = current_suite_xls.getCellData(Constants.TEST_CASES_SHEET, Constants.TEST_SUITE_RUNMODE, currentTestCaseID);
				  ...
				  if(suiteXLS.getCellData(Constants.TEST_SUITE_SHEET, Constants.TEST_SUITE_RUNMODE,currentSuiteID).equalsIgnoreCase(Constants.RUNMODE_YES))
